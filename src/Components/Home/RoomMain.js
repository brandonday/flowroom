        ...
        componentDidMount() {
            ...
            function myFunction(x) {
                if (x.matches) { // If media query matches
                    ...
                    document.getElementsByClassName('main-section-wrap-comments-box')[0].style.paddingLeft = '29px';
                    document.getElementsByClassName('main-section-wrap-comments-box')[0].style.paddingRight = '40px';
...
{/*                                     
                                        ...
                                        <div style={{marginBottom:8}}>
                                            <svg width="30px" height="12px" viewBox="0 0 26 10" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Overlay3" transform="translate(0.000000, 1.000000)">
            <polygon id="Triangle" stroke="#FFF" stroke-width="0.8" fill="#FFF" points="5 1 9 9 1 9"></polygon>
            <text id="T" font-family="AmericanTypewriter, American Typewriter" font-size="13" font-weight="600" fill="#FFF">
                <tspan x="13" y="21">T</tspan>
            </text>
            <g id="happiness" transform="translate(13.000000, 0.000000)">
                <circle id="Oval-5" stroke="#FFF" fill="#FFF" cx="4.5" cy="4.5" r="4.5"></circle>
            ...
            <g id="iconmonstr-favorite-3" transform="translate(0.000000, 12.000000)" fill="#FFF" fill-rule="nonzero">
                <path d="M5,1.32878377 C3.68833333,-0.88110905 0,-0.235977438 0,2.53313853 C0,4.43989722 2.32125,6.38961013 5,9 C7.67916667,6.38961013 10,4.43989722 10,2.53313853 C10,-0.245386459 6.30208333,-0.864745534 5,1.32878377 Z" id="Shape"></path>
                                    ...
                                    <Tab tabFor="vertical-tab-three" onClick={()=>{this.activeTab(2)}} className={this.state.activeTab == 2 ? 'activeClass' : ''} style={{height:78,width:78,display:'flex',justifyContent:'center',alignItems:'center',flexDirection:'column'}}>
                                        {/* <div id="app-tag"  
                                            ...
                                            <div style={{marginBottom:8}}>
                                            <svg class="sc-bdVaJa fUuvxv" fill="white" width="30" height="25" viewBox="0 0 1024 1024" rotate="0">
                                    ...
                                    <Tab tabFor="vertical-tab-four" onClick={()=>{this.activeTab(3)}} className={this.state.activeTab == 3 ? 'activeClass' : ''} style={{height:78,width:78,display:'flex',justifyContent:'center',alignItems:'center',flexDirection:'column'}}>
                                        {/* <div id="script-tag" refs="script-tag" onClick={this.ScriptTag.bind(this)}
                                            ...
                                            style={{
                                                ...
                                                <div style={{marginBottom:8}}>
                                                    <svg width="25px" height="30px" viewBox="0 0 18 14" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                        <g id="Mobile" stroke="none" stroke-width="1.3" fill="none" fill-rule="evenodd">
                                            ...
                                            className="menu-bg-border">
                                                ...
                                                <div style={{marginBottom:8}}>
                                                    <svg width="20" height="20" viewBox="0 0 15 15" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <g id="Mobile" stroke="none" stroke-width="0.8" fill="none" fill-rule="evenodd">
