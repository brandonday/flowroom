        ...
        this.props.startCreateRoom(
            {
                ...
                views:0,
                likes:0,
                html:this.props.state.dhtml.dhtml.html == undefined ? '' : this.props.state.dhtml.dhtml.html,
                css:this.props.state.dhtml.dhtml.css == undefined ? '': this.props.state.dhtml.dhtml.css,
                js:this.props.state.dhtml.dhtml.js == undefined ? '' : this.props.state.dhtml.dhtml.js,
                pic:this.state.pic,
                objectNum:'',
                date: new Date(),
                filterGroup:'',
        ...
        if(this.props.state.entireApp.modalType === 'message') {
            ...
            return (
                <div style={{display:'flex', flexDirection:'column'}}>
                    ...
                    <div id="thumbnail-pic-box" style={{display:'block', flexDirection:'column'}}>
                        <div style={{display:'flex'}}>
